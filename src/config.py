...
OPTIONAL_ENV_VARS = ["AZURE_BLOB_NAME", "AZURE_BLOB"]
...
MULTI_VALUED_DATE_COLS = {"cargo_receiveds_date", "cargo_ready_date"}

# Columns containing multiple values (IDs) - to be split into lists
MULTI_VALUED_ID_COLS = ["po_numbers", "booking_numbers", "fcr_numbers", "obl_nos"]
