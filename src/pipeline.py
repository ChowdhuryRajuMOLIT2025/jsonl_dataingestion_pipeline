...
def setup_logging():
    ...
    if not logger.handlers:
        ...
        try:
            ...
            f_format = logging.Formatter("[%(levelname)s] %(asctime)s | %(module)s | %(message)s")
    ...
    def run(self):
        try:
            ...
            if not target_container:
                logger.warning("AZURE_STORAGE_CONTAINER_UPLD not set. Defaulting to 'shipment-csv-data'.")
            ...
            logger.info(f"Pipeline executed successfully in {total_duration:.2f} seconds.")
